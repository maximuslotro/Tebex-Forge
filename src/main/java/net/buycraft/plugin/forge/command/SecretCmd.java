...
public class SecretCmd extends Subcommand {
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) {
        if (sender != server) {
            ForgeMessageUtil.sendMessage(sender, new ChatComponentText(ForgeMessageUtil.format("secret_console_only"))
        ...
        if(secret == null) {
            ForgeMessageUtil.sendMessage(sender, new ChatComponentText(
        ...
        plugin.getPlatform().executeAsync(() -> {
            ...
            try {
                ...
                ForgeMessageUtil.sendMessage(sender, new ChatComponentText(ForgeMessageUtil.format("secret_does_not_work"))
                        .setChatStyle(BuycraftPlugin.ERROR_STYLE));
                return;
            }
            ...
            try {
                ...
                ForgeMessageUtil.sendMessage(sender, new ChatComponentText(ForgeMessageUtil.format("secret_cant_be_saved"))
                        .setChatStyle(BuycraftPlugin.ERROR_STYLE));
            }

            ForgeMessageUtil.sendMessage(sender, new ChatComponentText(ForgeMessageUtil.format("secret_success",
                    information.getServer().getName(), information.getAccount().getName())).setChatStyle(BuycraftPlugin.SUCCESS_STYLE));
