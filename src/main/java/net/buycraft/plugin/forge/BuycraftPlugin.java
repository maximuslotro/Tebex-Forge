...
public class BuycraftPlugin {
    ...
    public static final ChatStyle SUCCESS_STYLE = new ChatStyle().setColor(EnumChatFormatting.GREEN);
    public static final ChatStyle INFO_STYLE = new ChatStyle().setColor(EnumChatFormatting.YELLOW);
    public static final ChatStyle ERROR_STYLE = new ChatStyle().setColor(EnumChatFormatting.RED);
    ...
    public void onPlayerJoin(PlayerEvent.PlayerLoggedInEvent event) {
        if (FMLServerHandler.instance().getServer() != null && FMLServerHandler.instance().getSide()==Side.SERVER) {
            if (apiClient == null) {
                return;
            }

            QueuedPlayer qp = duePlayerFetcher.fetchAndRemoveDuePlayer(event.player.getDisplayName());
            if (qp != null) {
